...
public class CreateGetAccount extends BaseTest {
    ...
    public void createAccountTest() {
        Account account = new Account("Test Account3", "0015g00000OYQYgAAP", "Investor", "test", "Banking",
    ...
    public void getAccountTest() {
        ResponseAccount actual = new AccountAdapter().getAccount("0015g00000OYSDhAAP");
